...
export default function Signup() {
  ...
  const handleGoogleSignup = async () => {
    try {
      ...
      addToast(error.message || 'Failed to sign up with Google', 'error');
    }
  };
      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-neutral-900 rounded-lg border border-neutral-200 dark:border-neutral-700 p-8 shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <FormRow label="Password" htmlFor="password" required help="At least 8 characters">
              <div className="relative">
