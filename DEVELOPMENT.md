...
```bash
git remote add encore encore://veribuild-ai-agents-page-7ayi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/veribuild-ai-agents-page-7ayi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/veribuild-ai-agents-page-7ayi/settings/integrations/github)
